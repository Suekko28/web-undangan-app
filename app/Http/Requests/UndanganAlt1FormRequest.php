...
class UndanganAlt1FormRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'banner_img' => ['required', 'image', 'mimes:jpeg,png,jpg', 'max:5000'],
            'foto_prewedding' => ['required', 'image', 'mimes:jpeg,png,jpg', 'max:5000'],
            'foto_mempelai_laki' => ['required', 'image', 'mimes:jpeg,png,jpg', 'max:5000'],
            'nama_mempelai_laki' => ['required', 'string', 'max:100'],
            'putra_dari_bpk' => ['required', 'string', 'max:100'],
            'putra_dari_ibu' => ['required', 'string', 'max:100'],
            'foto_mempelai_perempuan' => ['required', 'image', 'mimes:jpeg,png,jpg', 'max:5000'],
            ...
            'foto_pertemuan' => ['', 'image', 'mimes:jpeg,png,jpg', 'max:5000'],
            'foto_pendekatan' => ['', 'image', 'mimes:jpeg,png,jpg', 'max:5000'],
            'foto_lamaran' => ['', 'image', 'mimes:jpeg,png,jpg', 'max:5000'],
            'foto_pernikahan' => ['', 'image', 'mimes:jpeg,png,jpg', 'max:5000'],
