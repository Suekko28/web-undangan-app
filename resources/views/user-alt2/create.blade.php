    ...
    <main>
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <form action="{{ route('nama-undangan-store2', ['id' => $undanganAlt2Id]) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="undangan_alt2_id" value="{{ $undanganAlt2->id }}">
                    <div class="card-body container bg-white mt-5">
                        ...
                        <div class="d-flex flex-row-reverse mt-5">
                            ...
                            <a href="{{ route('nama-undangan-list2', ['id' => $undanganAlt2Id]) }}" class="btn btn-danger">Batal</a>
                        </div>
