...
@section('navbar-admin')
    <main>
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <!-- Responsive Table -->
            <div class="card">
                <h5 class="card-header">Undangan Alternative 3</h5>
                <div class="p-3">
                    <div class="mb-3">
                ...
                <div class="table-responsive text-nowrap p-3">
                    <form id="deleteForm" action="{{ route('undangan-alternative2.destroy') }}" method="POST">
                        @csrf
                        @method('DELETE')
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <td>
                                            <div class="btn-group-vertical">
                                                ...
                                                <a href="{{ route('undangan-alternative3-view', ['id' => $item->id]) }}"
                                                    class="btn btn-info rounded mb-2">
                                                    <i class="fa fa-eye" style="color:white;"></i>
                                                </a>
                                                <a href="{{ route('undangan-alt3-home', [
